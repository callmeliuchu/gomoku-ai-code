...
GAMES_PER_ITER="${GAMES_PER_ITER:-40}"
...
EARLY_STOP_LOSS="${EARLY_STOP_LOSS:-0.30}"
EARLY_STOP_PATIENCE="${EARLY_STOP_PATIENCE:-12}"
EARLY_STOP_MIN_ITERATIONS="${EARLY_STOP_MIN_ITERATIONS:-160}"
SEED="${SEED:-42}"
DEVICE="${DEVICE:-auto}"

OUTPUT_CHECKPOINT="${OUTPUT_CHECKPOINT:-$ROOT_DIR/gomoku_ppo_7x7_5.pt}"
