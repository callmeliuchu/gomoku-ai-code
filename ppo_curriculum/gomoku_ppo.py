#!/usr/bin/env python3
"""Curriculum-friendly Gomoku PPO training.

This is a standalone PPO line intended for:
5x5 connect-4 -> 7x7 connect-5 -> 9x9 connect-5 -> 15x15 connect-5.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Standalone Gomoku PPO curriculum trainer")
