...
BUFFER_SIZE="${BUFFER_SIZE:-120000}"
LR="${LR:-3e-4}"
WEIGHT_DECAY="${WEIGHT_DECAY:-1e-4}"
VALUE_COEF="${VALUE_COEF:-1.0}"
MCTS_SIMS="${MCTS_SIMS:-224}"
EVAL_MCTS_SIMS="${EVAL_MCTS_SIMS:-448}"
C_PUCT="${C_PUCT:-1.5}"
TEMPERATURE="${TEMPERATURE:-0.60}"
TEMPERATURE_DROP_MOVES="${TEMPERATURE_DROP_MOVES:-3}"
DIRICHLET_ALPHA="${DIRICHLET_ALPHA:-0.04}"
NOISE_EPS="${NOISE_EPS:-0.10}"
RANDOM_OPENING_MOVES="${RANDOM_OPENING_MOVES:-2}"
OPENING_SAMPLER="${OPENING_SAMPLER:-diverse}"
OPENING_OUTER_RING_PROB="${OPENING_OUTER_RING_PROB:-0.45}"
OPENING_NON_CENTER_PROB="${OPENING_NON_CENTER_PROB:-0.80}"
...
EARLY_STOP_HEURISTIC_WIN_RATE="${EARLY_STOP_HEURISTIC_WIN_RATE:-0.20}"
EARLY_STOP_HEURISTIC_PATIENCE="${EARLY_STOP_HEURISTIC_PATIENCE:-3}"
SEED="${SEED:-42}"
DEVICE="${DEVICE:-auto}"

OUTPUT_CHECKPOINT="${OUTPUT_CHECKPOINT:-$ROOT_DIR/gomoku_az_13x13_5.pt}"
