...
OPENING_OUTER_RING_PROB="${OPENING_OUTER_RING_PROB:-0.55}"
OPENING_NON_CENTER_PROB="${OPENING_NON_CENTER_PROB:-0.85}"
...
EARLY_STOP_HEURISTIC_WIN_RATE="${EARLY_STOP_HEURISTIC_WIN_RATE:-0.10}"
