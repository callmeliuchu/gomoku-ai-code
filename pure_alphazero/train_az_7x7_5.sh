...
TEMPERATURE_DROP_MOVES="${TEMPERATURE_DROP_MOVES:-5}"
DIRICHLET_ALPHA="${DIRICHLET_ALPHA:-0.15}"
...
EARLY_STOP_LOSS="${EARLY_STOP_LOSS:-0.80}"
EARLY_STOP_PATIENCE="${EARLY_STOP_PATIENCE:-12}"
EARLY_STOP_MIN_ITERATIONS="${EARLY_STOP_MIN_ITERATIONS:-140}"
EARLY_STOP_HEURISTIC_WIN_RATE="${EARLY_STOP_HEURISTIC_WIN_RATE:-0.50}"
...
OUTPUT_CHECKPOINT="${OUTPUT_CHECKPOINT:-$ROOT_DIR/gomoku_az_7x7_5.pt}"
