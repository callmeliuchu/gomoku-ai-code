...
MCTS_SIMS="${MCTS_SIMS:-192}"
EVAL_MCTS_SIMS="${EVAL_MCTS_SIMS:-384}"
C_PUCT="${C_PUCT:-1.5}"
TEMPERATURE="${TEMPERATURE:-0.74}"
TEMPERATURE_DROP_MOVES="${TEMPERATURE_DROP_MOVES:-4}"
DIRICHLET_ALPHA="${DIRICHLET_ALPHA:-0.07}"
NOISE_EPS="${NOISE_EPS:-0.12}"
RANDOM_OPENING_MOVES="${RANDOM_OPENING_MOVES:-4}"
...
EARLY_STOP_HEURISTIC_WIN_RATE="${EARLY_STOP_HEURISTIC_WIN_RATE:-0.25}"
EARLY_STOP_HEURISTIC_PATIENCE="${EARLY_STOP_HEURISTIC_PATIENCE:-3}"
SEED="${SEED:-42}"
DEVICE="${DEVICE:-auto}"

OUTPUT_CHECKPOINT="${OUTPUT_CHECKPOINT:-$ROOT_DIR/gomoku_az_large_11x11_5.pt}"
