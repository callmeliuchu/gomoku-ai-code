...
OUTPUT_CHECKPOINT="${OUTPUT_CHECKPOINT:-$ROOT_DIR/gomoku_mcts_7x7_5.pt}"
...
EVAL_MCTS_SIMS="${EVAL_MCTS_SIMS:-256}"
...
EARLY_STOP_LOSS="${EARLY_STOP_LOSS:-0.15}"
EARLY_STOP_PATIENCE="${EARLY_STOP_PATIENCE:-20}"
EARLY_STOP_MIN_ITERATIONS="${EARLY_STOP_MIN_ITERATIONS:-250}"
...
DIRICHLET_ALPHA="${DIRICHLET_ALPHA:-0.12}"
