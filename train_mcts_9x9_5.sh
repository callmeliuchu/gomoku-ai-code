...
OUTPUT_CHECKPOINT="${OUTPUT_CHECKPOINT:-$ROOT_DIR/gomoku_mcts_9x9_5.pt}"
...
BUFFER_SIZE="${BUFFER_SIZE:-70000}"

MCTS_SIMS="${MCTS_SIMS:-160}"
EVAL_MCTS_SIMS="${EVAL_MCTS_SIMS:-320}"
...
EARLY_STOP_LOSS="${EARLY_STOP_LOSS:-1.05}"
...
DIRICHLET_ALPHA="${DIRICHLET_ALPHA:-0.08}"
